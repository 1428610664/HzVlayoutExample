package com.hz.hzvlayoutexample.presenter;
...
import com.hz.hzvlayoutexample.Constant;
...
import com.hz.hzvlayoutexample.base.BaseViewHolder;
import com.hz.hzvlayoutexample.contract.FindFragmentContract;
import com.hz.hzvlayoutexample.entity.HomeBlogEntity;
import com.hz.hzvlayoutexample.utils.ImageUtils;
import com.hz.hzvlayoutexample.weight.MarqueeView;
...
public class FindFragmentPresenter implements FindFragmentContract.Presenter {
    ...
    public BaseDelegateAdapter initBannerAdapter() {
        ...
        arrayList.clear();
        arrayList.add("https://m.360buyimg.com/mobilecms/s756x368_jfs/t19732/101/2087044643/275257/55f2e80e/5ae336d9N2e8b169b.jpg!cr_1125x549_0_72!q70.jpg.dpg.webp");
        arrayList.add("https://m.360buyimg.com/mobilecms/s756x368_jfs/t18703/40/1974546412/314635/c0214e8b/5ae14779Nf9f1fa46.jpg!cr_1125x549_0_72!q70.jpg.dpg.webp");
        ...
        return new BaseDelegateAdapter(activity, new LinearLayoutHelper(), R.layout.view_vlayout_banner, 1, Constant.viewType.typeBanner) {
            ...
            public void onBindViewHolder(BaseViewHolder holder, int position) {
                ...
                // 绑定数据
                SliderLayout mBanner = holder.getView(R.id.slider);
                mBanner.removeAllSliders();
                for(String item : arrayList){
                    DefaultSliderView slider = new DefaultSliderView(activity);
                    slider.image(item);
                    slider.setScaleType(BaseSliderView.ScaleType.Fit);
                    mBanner.addSlider(slider);
                }
                ...
                mBanner.setPresetTransformer(SliderLayout.Transformer.RotateDown);
